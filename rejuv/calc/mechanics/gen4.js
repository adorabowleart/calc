...
function calculateDPP(gen, attacker, defender, move, field) {
    ...
    (0, util_1.checkDownload)(attacker, defender, field);
    (0, util_1.checkDownload)(defender, attacker, field);
    ...
    var fixedDamage = (0, util_1.handleFixedDamageMoves)(attacker, move, field);
    if (fixedDamage) {
