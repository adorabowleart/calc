...
export type Terrain = 'Ashen-Beach' | 'Back-Alley' | 'Bewitched' | 'Big-Top' | 'Blessed' | 'Cave' | 'Chess' | 'City' | 'Colosseum' | 'Concert-NH' | 'Concert-LH' | 'Concert-H' | 'Concert-SH' | 'Corrosive' | 'Corrosive-Mist' | 'Corrupted' | 'Crystal' | 'Dark-Crystal' | 'Deep-Earth' | 'Desert' | 'Dimensional' | 'Dragon-Den' | 'Electric' | 'Factory' | 'Fairy-Tale' | 'Flower-Garden-1' | 'Flower-Garden-2' | 'Flower-Garden-3' | 'Flower-Garden-4' | 'Flower-Garden-5' | 'Forest' | 'Frozen' | 'Glitch' | 'Grassy' | 'Haunted' | 'Icy' | 'Infernal' | 'Inverse' | 'Mirror' | 'Misty' | 'Mountain' | 'Murkwater' | 'New-World' | 'Psychic' | 'Rainbow' | 'Rocky' | 'Sky' | 'Short-Circuit-0.8' | 'Short-Circuit-1.5' | 'Short-Circuit-0.5' | 'Short-Circuit-1.2' | 'Short-Circuit-2' | 'Snowy-Mountain' | 'Starlight' | 'Swamp' | 'Underwater' | 'Volcanic' | 'Volcanic-Top' | 'Wasteland' | 'Water';
export type Weather = 'Sand' | 'Sun' | 'Rain' | 'Hail' | 'Snow' | 'Harsh Sunshine' | 'Heavy Rain' | 'Strong Winds' | 'Shadow Sky';
...
export type TypeName = 'Normal' | 'Fighting' | 'Flying' | 'Poison' | 'Ground' | 'Rock' | 'Bug' | 'Ghost' | 'Steel' | 'Shadow' | 'Fire' | 'Water' | 'Grass' | 'Electric' | 'Psychic' | 'Ice' | 'Dragon' | 'Dark' | 'Fairy' | '???';
