...
export type Terrain = 'Ashen Beach' | 'Big Top' | 'Burning' | 'Cave' | 'Chess Board' | 'Corrosive' | 'Corrosive Mist' | 'Crystal' | 'Dark Crystal' | 'Desert' | 'Dragon\'s Den' | 'Electric' | 'Factory' | 'Fairy Tale' | 'Flower Garden' | 'Forest' | 'Glitch' | 'Grassy' | 'Holy' | 'Icy' | 'Inverse' | 'Mirror' | 'Misty' | 'Mountain' | 'Murkwater' | 'New World' | 'Psychic' | 'Rainbow' | 'Rocky' | 'Short-Circuit' | 'Snowy Mountain' | 'Starlight' | 'Superheated' | 'Swamp' | 'Underwater' | 'Wasteland' | 'Water';
